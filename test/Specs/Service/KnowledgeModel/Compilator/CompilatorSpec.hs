   ...
   -- ---------------
    describe "Apply:  Question Events" $ do
      it "Apply:  AddQuestionEvent" $ do
        ...
        let expected =
              (questionsL .~ [question1', question2', q2_aYes_fuQuestion1', q2_aYes_fuq1_aYes_fuQuestion2', question3Plain', question9', question10']) .
              (chaptersM . at (chapter1 ^. uuid) ?~ (chapter1 & questionUuids .~ [question1 ^. uuid, question2 ^. uuid, question3 ^. uuid])) $
              km1
        computed `shouldBe` expected
      it "Apply:  EditQuestionEvent" $ do
        let (Right computed) = runApplicator (Just km1) [EditQuestionEvent' e_km1_ch1_q2']
        let expected =
              (questionsL .~ [question1', question2Edited', q2_aYes_fuQuestion1', q2_aYes_fuq1_aYes_fuQuestion2', question3', question9', question10']) $
              km1
        computed `shouldBe` expected
      it "Apply:  EditQuestionEvent 2" $ do
        ...
        let expected =
              (questionsM . at (question4Edited ^. uuid) ?~ question4Edited') $
              km1WithQ4
        computed `shouldBe` expected
      ...
      it "Apply:  DeleteQuestionEvent" $ do
        ...
        let expected =
              (questionsL .~ [question1', question2', q2_aYes_fuQuestion1', q2_aYes_fuq1_aYes_fuQuestion2', question9', question10']) .
              (answersL .~ [ q2_answerNo, q2_answerYes, q2_aYes_fuq1_answerNo, q2_aYes_fuq1_answerYes, q2_aYes_fuq1_aYes_fuq2_answerNo, q2_aYes_fuq1_aYes_fuq2_answerYes]) $
              km1
        computed `shouldBe` expected
   -- ---------------
    describe "Apply:  Answer Events" $ do
      it "Apply:  AddAnswerEvent" $ do
        ...
        let expected =
              (questionsM . at (question2 ^. uuid) ?~ (question2' & answerUuids' .~ [q2_answerNo ^. uuid, q2_answerYes ^. uuid, q2_answerMaybe ^. uuid])) .
              (answersL .~ [q2_answerNo, q2_answerYes, q2_answerMaybe, q2_aYes_fuq1_answerNo, q2_aYes_fuq1_answerYes, q2_aYes_fuq1_aYes_fuq2_answerNo, q2_aYes_fuq1_aYes_fuq2_answerYes, q3_answerNo, q3_answerYes]) $
              km1
        computed `shouldBe` expected
      it "Apply:  EditAnswerEvent" $ do
        let (Right computed) = runApplicator (Just km1) [EditAnswerEvent' e_km1_ch1_q2_aYes1]
        let expected =
              (answersL .~ [q2_answerNo, q2_answerYesEdited, q2_aYes_fuq1_answerNo, q2_aYes_fuq1_answerYes, q2_aYes_fuq1_aYes_fuq2_answerNo, q2_aYes_fuq1_aYes_fuq2_answerYes, q3_answerNo, q3_answerYes]) $
              km1
        computed `shouldBe` expected
   ...
   -- ---------------
    describe "Apply:  Follow-Up Question Events" $ do
      it "Apply:  AddFollowUpQuestionEvent" $ do
        ...
        let expected =
              (questionsM . at (q2_aYes1_fuq1_aYes3_fuq2_aYes4_fuQuestion3 ^. uuid) ?~ q2_aYes1_fuq1_aYes3_fuq2_aYes4_fuQuestion3') .
              (answersM . at (q2_aYes_fuq1_aYes_fuq2_answerYes ^. uuid) ?~ (q2_aYes_fuq1_aYes_fuq2_answerYes & followUpUuids .~ [q2_aYes1_fuq1_aYes3_fuq2_aYes4_fuQuestion3 ^. uuid])) $
              km1
        computed `shouldBe` expected
      ...
      it "Apply:  DeleteFollowUpQuestionEvent" $ do
        ...
        let expected =
              ...
              (answersL .~ [q2_answerNo, q2_answerYes, q2_aYes_fuq1_answerNo, q2_aYes_fuq1_answerYes & followUpUuids .~ [], q3_answerNo, q3_answerYes]) $
              km1
        computed `shouldBe` expected
   -- ---------------
    describe "Apply:  AnswerItemTemplateQuestion Events" $ do
      it "Apply:  AddAnswerItemTemplateQuestionEvent" $ do
        ...
        let expected =
              ...
              (questionsM . at (question4 ^. uuid) ?~ (question4' & itemTemplateQuestionUuids' .~ [q4_it1_question5Plain ^. uuid])) $
              km1WithQ4Plain
        computed `shouldBe` expected
      it "Apply:  EditAnswerItemTemplateQuestionEvent" $ do
        ...
        let (Right computed) = runApplicator (Just km1WithQ4) [EditQuestionEvent' event]
        let expected =
              (questionsM . at (q4_it1_question5Edited ^. uuid) ?~ q4_it1_question5Edited') $
              km1WithQ4
        computed `shouldBe` expected
      it "Apply:  DeleteAnswerItemTemplateQuestionEvent" $ do
        ...
        let expected =
              (questionsL .~ [ question1', question2', q2_aYes_fuQuestion1', q2_aYes_fuq1_aYes_fuQuestion2', question3', question4' & itemTemplateQuestionUuids' .~ [q4_it1_question6 ^. uuid], q4_it1_question6', q4_it1_q6_aYes_followUpQuestion4', q4_it1_q6_aYes_fuq4_it_question1', q4_it1_q6_aYes_fuq4_it_question2', q4_it1_q6_aYes_followUpQuestion5', question9', question10']) $
              km1WithQ4
        computed `shouldBe` expected
   -- ---------------
    describe "Apply:  Expert Events" $ do
      it "Apply:  AddExpertEvent" $ do
        ...
        let expected =
              (questionsM . at (question2 ^. uuid) ?~ (question2' & expertUuids' .~ [km1_ch1_q2_eAlbert ^. uuid, km1_ch1_q2_eNikola ^. uuid, km1_ch1_q2_eIsaac ^. uuid])) .
      ...
      it "Apply:  EditExpertEvent" $ do
        ...
        let expected =
              (expertsL .~ [km1_ch1_q2_eAlbertEdited, km1_ch1_q2_eNikola]) $
              km1
        computed `shouldBe` expected
   ...
   -- ---------------
    describe "Apply:  Reference Events" $ do
      it "Apply:  AddReferenceEvent" $ do
        ...
        let expected =
              (questionsM . at (question2 ^. uuid) ?~ (question2' & referenceUuids' .~ [km1_ch1_q2_r1 ^. uuid, km1_ch1_q2_r2 ^. uuid, km1_ch1_q2_r3 ^. uuid])) .
      ...
      it "Apply:  EditReferenceEvent" $ do
        ...
        let expected =
              (referencesL .~ [km1_ch1_q2_r1Edited', km1_ch1_q2_r2']) $
              km1
        computed `shouldBe` expected
