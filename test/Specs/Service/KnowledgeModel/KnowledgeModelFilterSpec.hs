    ...
    it "1 tag provided" $
     ...
     do
      ...
      let inKm = km1WithQ4
        -- AND: Prepare expectations
      let expectedKm =
            (chaptersL .~ [chapter1 & questionUuids .~ [question1 ^. uuid], chapter2 & questionUuids .~ [], chapter3 & questionUuids .~ []]) .
    ...
    it "2 tags provided" $
     ...
     do
      ...
      let expectedKm =
            ...
            (questionsL .~ [question1', question2',q2_aYes_fuQuestion1', question4' & itemTemplateQuestionUuids' .~ [q4_it1_question5Plain ^. uuid] , q4_it1_question5Plain', question9', question10']) .
            (answersL .~ [q2_answerNo, q2_answerYes, q2_aYes_fuq1_answerNo, q2_aYes_fuq1_answerYes]) .
            (referencesL .~ [km1_ch1_q2_r1', km1_ch1_q2_r2']) .
            (expertsL .~ [km1_ch1_q2_eAlbert, km1_ch1_q2_eNikola]) $
            km1WithQ4
        -- WHEN:
      let computedKm = filterKnowledgeModel inTags inKm
        -- THEN:
