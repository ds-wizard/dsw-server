      ...
      it "it works (nested fields)" $
       ...
       do
        ...
        let expectation =
              Right
                [ TypehintIDTO
                  { _typehintIDTOIntId = "op-p000001"
                  , _typehintIDTOName = "Life Science Ontology"
                  }
                , TypehintIDTO
                  { _typehintIDTOIntId = "op-p000008"
                  , _typehintIDTOName = "Mathematical Ontology"
                  }
                ]
        -- WHEN:
