...
doIsCleanerMethod km (EditIntegrationEvent' event) = not $ isThereAnyIntegrationWithGivenUuid km (event ^. integrationUuid)
doIsCleanerMethod km (DeleteIntegrationEvent' event) = not $ isThereAnyIntegrationWithGivenUuid km (event ^. integrationUuid)
