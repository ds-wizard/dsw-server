        ...
        case M.lookup (getEventParentUuid event) (km ^. chaptersM) of
          ...
          Nothing ->
            case M.lookup (getEventParentUuid event) (km ^. questionsM) of
              Just parent ->
                km & (questionsM . at (getEventParentUuid event)) ?~ (parent & ap itemTemplateQuestionUuids' .~ (getEventNodeUuid event))
              Nothing ->
                case M.lookup (getEventParentUuid event) (km ^. answersM) of
                  Just parent ->
                    km & (answersM . at (getEventParentUuid event)) ?~ (parent & ap followUpUuids .~ (getEventNodeUuid event))
                  Nothing -> km
      ...
      deleteEntityReference km =
        case M.lookup (getEventParentUuid event) (km ^. chaptersM) of
          ...
          Nothing ->
            case M.lookup (getEventParentUuid event) (km ^. questionsM) of
              Just parent ->
                km & (questionsM . at (getEventParentUuid event)) ?~ (parent & del itemTemplateQuestionUuids' .~ (getEventNodeUuid event))
              Nothing ->
                case M.lookup (getEventParentUuid event) (km ^. answersM) of
                  Just parent ->
                    km & (answersM . at (getEventParentUuid event)) ?~ (parent & del followUpUuids .~ (getEventNodeUuid event))
                  Nothing -> km
