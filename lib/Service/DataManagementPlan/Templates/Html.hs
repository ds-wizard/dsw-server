...
chapter2html ctx dmp chapter =
  H.section ! A.class_ "chapter" ! A.id (stringValue . U.toString $ chapter ^. uuid) $ do
    ...
    mapM_ (question2html ctx) (chapter ^. questions)
...
question2html :: DataManagementPlanTemplateContext -> FilledQuestionDTO -> H.Html
question2html ctx question =
...
answerSimple2html :: DataManagementPlanTemplateContext -> String -> H.Html
answerSimple2html _ answer =
  H.div ! A.class_ "answer-block answer-simple" $ do
    H.h4 . H.toHtml $ "Answer"
    H.p ! A.class_ "answer" $ H.toHtml answer

answerOption2html :: DataManagementPlanTemplateContext -> FilledAnswerDTO -> H.Html
answerOption2html ctx answer =
  H.div ! A.class_ "answer-block answer-option" ! A.id (stringValue . U.toString $ answer ^. uuid) $ do
    ...
    case answer ^. advice of
      ...
      Nothing -> H.toHtml ""
    H.div ! A.class_ "followups" $ mapM_ (question2html ctx) (answer ^. followUps)

answerItems2html :: DataManagementPlanTemplateContext -> [FilledAnswerItemDTO] -> H.Html
answerItems2html ctx answerItems =
  H.div ! A.class_ "answer-block answer-items" $ do
    H.h4 . H.toHtml $ "Answers"
    mapM_ (answerItem2html ctx) answerItems

answerItem2html :: DataManagementPlanTemplateContext -> FilledAnswerItemDTO -> H.Html
answerItem2html ctx answerItem =
  H.div ! A.class_ "answer-block answer-item" $ do
    ...
    H.div ! A.class_ "followups" $ mapM_ (question2html ctx) (answerItem ^. questions)
